...
import com.anyi.common.config.AnyiConfig;
import com.anyi.common.constant.Constants;
import com.anyi.common.util.StringUtils;
import com.anyi.common.util.date.DateUtils;
import com.anyi.common.util.uuid.Seq;
...
public class FileUploadUtils {
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = AnyiConfig.getProfile();

    public static void setProfile(String profile) {
        profile = profile;
        defaultBaseDir = profile;
    }
    ...
    public static String upload(String baseDir, MultipartFile file, String[] allowedExtension)
        ...
        if (fileNamelength > FileUploadUtils.DEFAULT_FILE_NAME_LENGTH) {
            throw new BusinessException(SystemError.INVALID_PARAMETER);
        }
    ...
    public static String extractFilename(File file) {
        ...
        return StringUtils.format("{}/{}", DateUtils.datePath(), file.getName());
    }
    ...
    public static String getPathFileName(String uploadDir, String fileName) throws IOException {
        int dirLastIndex = AnyiConfig.getProfile().length() + 1;
    ...
    public static void assertAllowed(MultipartFile file, String[] allowedExtension)
        ...
        if (size > DEFAULT_MAX_SIZE) {
            throw new BaseException(BizError.FILE_SIZE_ERROR);
        }
