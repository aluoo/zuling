...
@NoArgsConstructor
@Builder
public class DiOrderPaymentUpdateDTO implements Serializable {
    ...
    public DiOrderPaymentUpdateDTO(PartnerTransactionsNotifyResult notifyResult) {
    ...
    public DiOrderPaymentUpdateDTO(PartnerTransactionsResult res) {
        ...
        this.openId = res.getPayer().getSubOpenid();
    }
}